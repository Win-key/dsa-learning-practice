...
public class Day1 {
    ...
    private static void partA() throws Exception {
        List<String> data = DataReader.readInput("file:///C:/Users/Windows/Documents/WinKey/Practice/AdvantOfCode/day1A.txt");
        int count = 0, i = 1;
        for (; i < data.size(); i++) {
    ...
    private static void partB() throws Exception {
        List<Integer> data = DataReader.readInput("file:///C:/Users/Windows/Documents/WinKey/Practice/AdvantOfCode/day1A.txt").stream().map(Integer::valueOf).collect(Collectors.toList());
